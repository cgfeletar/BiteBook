import { RecipeCreateInput, NutritionalInfo } from "../types";
...
function matchesMealType(text: string, mealType: string): boolean {
  ...
  const keywords: Record<string, string[]> = {
    breakfast: ["breakfast", "morning", "pancake", "waffle", "cereal", "oatmeal", "eggs", "toast"],
    lunch: ["lunch", "sandwich", "salad", "wrap", "soup"],
    dinner: ["dinner", "supper", "main course", "entree"],
    snack: ["snack", "trail mix", "chips", "crackers"],
    appetizer: ["appetizer", "appetiser", "starter", "hors d'oeuvre", "finger food"],
    dessert: ["dessert", "sweet", "cake", "cookie", "pie", "ice cream", "pudding", "candy"],
    brunch: ["brunch"],
  };
...
function matchesCuisine(text: string, cuisine: string): boolean {
  const lowerText = text.toLowerCase();
  const keywords: Record<string, string[]> = {
    italian: ["italian", "pasta", "pizza", "risotto", "parmesan", "mozzarella", "basil", "oregano"],
    mexican: ["mexican", "taco", "burrito", "quesadilla", "salsa", "guacamole", "cilantro", "jalapeño"],
    japanese: ["japanese", "sushi", "ramen", "teriyaki", "miso", "wasabi", "soy sauce", "sake"],
    french: ["french", "brie", "baguette", "croissant", "ratatouille", "bouillabaisse"],
    thai: ["thai", "curry", "pad thai", "coconut milk", "lemongrass", "fish sauce"],
    indian: ["indian", "curry", "tandoori", "naan", "masala", "turmeric", "cumin", "garam masala"],
    greek: ["greek", "feta", "tzatziki", "hummus", "olive", "oregano"],
    chinese: ["chinese", "stir fry", "wonton", "dumpling", "soy sauce", "ginger", "sesame"],
    american: ["american", "burger", "hot dog", "bbq", "barbecue", "mac and cheese"],
    mediterranean: ["mediterranean", "olive oil", "hummus", "falafel", "tabbouleh"],
    ...
    "middle-eastern": ["middle eastern", "middle-eastern", "hummus", "falafel", "tahini", "za'atar"],
  };
...
function matchesDietary(
  ...
  const restrictedKeywords: Record<string, string[]> = {
    vegetarian: ["meat", "chicken", "beef", "pork", "fish", "seafood", "bacon", "sausage", "ham"],
    vegan: ["meat", "chicken", "beef", "pork", "fish", "seafood", "dairy", "milk", "cheese", "butter", "egg", "eggs", "honey", "yogurt", "cream"],
    "gluten-free": ["flour", "wheat", "bread", "pasta", "gluten", "barley", "rye"],
    "dairy-free": ["milk", "cheese", "butter", "cream", "yogurt", "dairy", "sour cream"],
    ...
    "nut-free": ["peanut", "almond", "walnut", "cashew", "nut", "nuts", "pecan", "hazelnut"],
