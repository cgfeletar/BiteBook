...
import { View, TextInput, Text, TouchableOpacity, KeyboardAvoidingView, Platform, ActivityIndicator, Alert } from 'react-native';
      ...
      >
        <View className="flex-1 justify-center px-8">
          ...
          <View>
            ...
            {isSignUp && (
              <View className="mb-4">
                <Text className="text-sm text-charcoal-gray mb-2 ml-1">Confirm Password</Text>
                <TextInput
                  className="bg-soft-beige rounded-2xl px-4 py-4 text-charcoal-gray text-base"
            ...
            {/* Submit Button */}
            <TouchableOpacity
              className="bg-sage-green rounded-2xl py-4 mt-6 items-center justify-center shadow-sm"
            ...
            <View className="flex-row justify-center items-center mt-6">
              ...
              <TouchableOpacity
                ...
                disabled={loading}
              >
                <Text className="text-sage-green text-sm font-semibold">
